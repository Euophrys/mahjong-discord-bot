...
const base_definitions = {
    ...
    "suji": "Suji refers to tiles three more or less than a tile. For example, <:2p:466437922669985823> and <:8p:466437922380316683> are suji of the <:5p:466437922732769290> tile. See this article for more information: https://riichi.wiki/Suji",
    ...
    "atozuke": "Atozuke is when a yaku is \"attached afterwards\". This can manifest in two ways: 1. \"kataagari\" (one-sided win). For example, a hand has only tanyao as potential yaku and is waiting on 1p and 4p -- this hand is \"kataagari\" (and thus atozuke) because it can only win with 4p. 2. the first meld isn't related to the final yaku (e.g., first meld is 999s, but the final yaku is ittsu-only with 123456789m.). Note there may be slight variations in the definition of atozuke depending on the ruleset.",
    ...
    "toutenkou": "Toutenkou is a special sanma mode popular in Kanto. The scoring is completely different, and it includes the <:5m:466437922401419274> tiles. Most points come from nukidora (gari) and kans rather than yaku, but hands do still need a yaku. More info at https://riichi.wiki/Toutenkou.",
...
const aliases = {
    ...
    "itsu": "ittsu",
    "ittsuu": "ittsu",
    "dokou": "sanshokudoukou",
    "sanshokudokou": "sanshokudoukou",
    "doukou": "sanshokudoukou",
    "hittori": "hms",
    "chiitoi": "chiitoitsu",
    "shaa": "sha",
    "xia": "sha",
    ...
    "mixedtriplets": "sanshokudoukou",
    "tripletriplets": "sanshokudoukou",
