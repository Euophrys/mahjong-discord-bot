module.exports = message => {
    ...
    return message.channel.send(`${intro} The dice rolled ${diceOne} and ${diceTwo}, for a total of ${total}. That means the break is in front of the ${order[total - 1]} player.`);
}
