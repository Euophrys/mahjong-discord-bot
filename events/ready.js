...
module.exports = client => {
  ...
  console.log(`Present in ${client.guilds.size} servers.`);
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    var job = schedule.scheduleJob(date, function(client, game){
      ...
      var message = `Hey, <@&670274611388219402>! Day ${i + 1} of the M-League finals between ${teamsString} is now live! Come watch at <https://abema.tv/now-on-air/mahjong> (or catch the VoD afterwards)! My money is on ${winner1} for the first hanchan, and ${winner2} for the second. Who do you think will win today?`;
