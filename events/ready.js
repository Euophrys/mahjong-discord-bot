...
module.exports = client => {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    var job = schedule.scheduleJob(date, function(client, game){
      ...
      var message = `Day ${i + 1} of the M-League semi-finals is now live! Playing today is ${teamsString}. Come watch at <https://abema.tv/now-on-air/mahjong> (or catch the VoD afterwards)! My money is on ${winner1} for the first hanchan, and ${winner2} for the second. React with the team you think will win!`;
