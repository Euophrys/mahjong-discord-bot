...
module.exports = async interaction => {
    ...
    if (request == translatedRequest) {
        return interaction.reply({content:"I didn't find any Mahjong terms in that message.", ephemeral: true});
    }

    return interaction.reply(`I think that's something like, "${translatedRequest}"`);
};
...
const translations = new Map([
    ...
    [/\bton\b/gi, "<:1z:466437921688518656>"],
    [/\bnan\b/gi, "<:2z:466437922594226187>"],
    [/\bsha\b/gi, "<:3z:466437922560671744>"],
    [/\bxia\b/gi, "<:3z:466437922560671744>"],
    [/\bpei\b/gi, "<:4z:466437922518728744>"],
    [/\buma\b/gi, "placement bonus"],
    [/\boka\b/gi, "ante"],
